...
uapi AvRet AvUapiTxEnableInfoFrames(pin AvPort* port, uint32 InfoFrames, uint8 Enable);
...
uapi AvRet AvUapiCheckEarcRx(pio AvPort *port);
...
uapi AvRet AvUapiEarcRxWriteCapData(pio AvPort *port, uint8 *Value, uint16 Count);
uapi AvRet AvUapiEarcRxGetAudioPacketStatus(pio AvPort *port, EarcAudioInterrupt* Intpt);
uapi AvRet AvUapiEarcRxClearAudioInterrupt(pio AvPort *port, EarcAudioInterrupt* Intpt);
uapi AvRet AvUapiEarcRxSetAudioInterface(pio AvPort *port);
uapi AvRet AvUapiEarcTxSetAudioInterface(pio AvPort *port);
uapi AvRet AvUapiDpRxDPCDInit(pin AvPort *port);
uapi AvRet AvUapiDevMeasureTj(pio AvDevice *device, int32 *Tj);

#define Gsv6k5AvUapiTxClearRxidReady           AvUapiTxClearRxidReady
#define Gsv6k5AvUapiTxDecryptSink              AvUapiTxDecryptSink
#define Gsv6k5AvUapiTxDisableCore              AvUapiTxDisableCore
#define Gsv6k5AvUapiTxEnableCore               AvUapiTxEnableCore
#define Gsv6k5AvUapiRxGetVideoLock             AvUapiRxGetVideoLock
#define Gsv6k5AvUapiRxGetAudioInternalMute     AvUapiRxGetAudioInternalMute
#define Gsv6k5AvUapiDisconnectPort             AvUapiDisconnectPort
#define Gsv6k5AvUapiTxEnableInfoFrames         AvUapiTxEnableInfoFrames
#define Gsv6k5AvUapiTxSetAudNValue             AvUapiTxSetAudNValue
#define Gsv6k5AvUapiRxGetPacketType            AvUapiRxGetPacketType
#define Gsv6k5AvUapiRxGetPacketContent         AvUapiRxGetPacketContent
#define Gsv6k5AvUapiTxGetSinkHdcpCapability    AvUapiTxGetSinkHdcpCapability
#define Gsv6k5AvUapiRxSetAudioInternalMute     AvUapiRxSetAudioInternalMute
#define Gsv6k5AvUapiTxCecInit                  AvUapiTxCecInit
#define Gsv6k5AvUapiTxCecSetLogicalAddr        AvUapiTxCecSetLogicalAddr
#define Gsv6k5AvUapiDpRxDPCDInit               AvUapiDpRxDPCDInit
...
#define GET_DP_SDP_INTR(SdpIntr, SdpType)       ((SdpIntr & ((uint32)0x01 << (SdpType * 2))) ? 1 : 0)
#define GET_DP_SDP_CHG_INTR(SdpIntr, SdpType)   ((SdpIntr & ((uint32)0x01 << (SdpType * 2 + 1))) ? 1 : 0)
#define GET_DP_MISC_INTR(MiscIntr, MiscType)    ((MiscIntr & ((uint32)0x01 << (MiscType))) ? 1 : 0)
#define CLR_DP_MISC_INTR(MiscIntr, MiscType)    (MiscIntr &= ~((uint32)0x01 << (MiscType)))
#define GET_DP_SDP_PKT_FLAG(SdpType)            (((port->content.dprx->DpRxSdpAvailable & ((uint16)0x01 << SdpType)) == 0) ? 0 : 1)
#define BIT(Location)                           ((uint8)1<<Location)
