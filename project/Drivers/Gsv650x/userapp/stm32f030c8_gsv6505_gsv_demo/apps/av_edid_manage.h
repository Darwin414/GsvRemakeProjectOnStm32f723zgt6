...
#define AvEdidBitCeabFREESYNC                 1<<15
...
#define AvEdidBitFreq3G3Lane                  1<<9
#define AvEdidBitFreq6G3Lane                  1<<10
#define AvEdidBitFreq6G4Lane                  1<<11
#define AvEdidBitFreq8G4Lane                  1<<12
#define AvEdidBitFreq10G4Lane                 1<<13
#define AvEdidBitFreq12G4Lane                 1<<14
...
#define AvEdidBitColorDepth420_36BIT          1<<6
#define AvEdidBitColorDepth420_30BIT          1<<7
...
typedef struct
{
    ...
    uint8  Y420FrlCheck [25];
    uint8  HdrStCheck [4];
    uint8  CdbCheck [9];
    uint8  DolbyVisionCheck;
    uint8  FreeSyncCheck [4];
